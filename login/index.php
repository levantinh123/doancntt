...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error)) {
        ...
        if ($is_check != null) {
            ...
            header("location: /doanchuyennganh/admin/");
        } else {
            //that bai
...
<head>
  ...
  <title>Login</title>
  <link href="/doanchuyennganh/public/admin/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="/doanchuyennganh/public/admin/css/sb-admin.css" rel="stylesheet">
  <link href="/doanchuyennganh/public/admin/css/login.css" rel="stylesheet">
